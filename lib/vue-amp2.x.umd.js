(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-amp2.x"] = factory();
	else
		root["vue-amp2.x"] = factory();
...
"use strict";
(function(m,p){ true?module.exports=p():undefined})(this,function(){function m(a){var b=[];a.AMapUI&&b.push(p(a.AMapUI));a.Loca&&b.push(r(a.Loca));return Promise.all(b)}function p(a){return new Promise(function(h,c){var e=[];if(a.plugins)for(var f=0;f<a.plugins.length;f+=1)-1==d.AMapUI.plugins.indexOf(a.plugins[f])&&e.push(a.plugins[f]);if(g.AMapUI===b.failed)c("\u524d\u6b21\u8bf7\u6c42 AMapUI \u5931\u8d25");
...
__webpack_require__.d(__webpack_exports__, "VueAmap2x", function() { return /* reexport */ src_amap; });
...
// CONCATENATED MODULE: ./src/amap/load/index.js
...
* @Last Modified time: 2020-09-04 14:36:07
* @E-mail: justbefree@126.com
*/

var load_loadMap = function loadMap() {
...
// CONCATENATED MODULE: ./src/amap/component/amap.js
...
/* harmony default export */ var amap = ({
  ...
  methods: {
    getMapInstance: function getMapInstance() {
      return this.map;
    },
    getCurrentZoom: function getCurrentZoom() {
      return this.zoom;
    },
    ...
    notify: function notify(type, message) {
      this.$emit(type, _objectSpread2({
        vueInstance: this
      }, message));
    },
    mapZoomStart: function mapZoomStart(e, map) {
      this.notify(e.type, {
        map: map
      });
    },
    mapZoom: function mapZoom(e, map) {
      this.notify(e.type, {
        map: map
      });
    },
    mapZoomEnd: function mapZoomEnd(e, map) {
      this.notify(e.type, {
        map: map
      });
    },
    ...
    mapMove: function mapMove(e, map) {
      this.notify(e.type, {
        map: map
      });
    },
    mapMoveEnd: function mapMoveEnd(e, map) {
      this.notify(e.type, {
        map: map
      });
    },
    mapDragStart: function mapDragStart(e, map) {
      this.notify(e.type, {
        map: map
      });
    },
    mapDragging: function mapDragging(e, map) {
      this.notify(e.type, {
        map: map
      });
    },
    mapDragEnd: function mapDragEnd(e, map) {
      this.notify(e.type, {
        map: map
      });
    },
    mapLoaded: function mapLoaded(e, map) {
      this.notify(e.type, {
        map: map
      });
    },
    installPlugin: function installPlugin() {
      ...
      var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var AMap = options.AMap;
      AMap.plugin(this.plugins, function () {
        _this.$emit("pluginInstalled", _objectSpread2({}, options));
      });
    },
    load: function load() {
      var _this2 = this;
      ...
      load_loadMap({
        ...
        var map = new AMap.Map('vue-amp2x-container', _objectSpread2({
          zoom: 13,
          zooms: [10, 19],
          center: center,
          touchZoomCenter: 1
        ...
        _this2.map = map;
        _this2.zoom = map.getZoom();

        _this2.installPlugin({
          AMap: AMap,
          map: map
        });

        map.on("zoomstart", function (e) {
          _this2.mapZoomStart(e, map);
        });
        map.on("zoomchange", function (e) {
          _this2.mapZoom(e, map);
        });
        map.on("zoomend", function (e) {
          _this2.mapZoomEnd(e, map);
        });
        map.on("movestart", function (e) {
          _this2.mapMoveStart(e, map);
        });
        map.on("mapmove", function (e) {
          _this2.mapMove(e, map);
        });
        map.on("moveend", function (e) {
          _this2.mapMoveEnd(e, map);
        });
        map.on("dragstart", function (e) {
          _this2.mapDragStart(e, map);
        });
        map.on("dragging", function (e) {
          _this2.mapDragging(e, map);
        });
        map.on("dragend", function (e) {
          _this2.mapDragEnd(e, map);
        });
        map.on("complete", function (e) {
          _this2.mapLoaded(e, map);
        });
      }).catch(function (err) {
  ...
  destroyed: function destroyed() {
    var autoDestroy = this.$props.autoDestroy;
  ...
  render: function render(h) {
    var defaultWidth = this.width || "".concat(document.documentElement.clientWidth, "px");
    var defaultHeight = this.height || "".concat(document.documentElement.clientHeight, "px");
    return h('div', {
      style: {
        width: defaultWidth,
...
// CONCATENATED MODULE: ./src/amap/index.js
/*
* @Author: Just be free
* @Date:   2020-08-07 11:11:35
* @Last Modified by:   Just be free
* @Last Modified time: 2020-09-07 15:00:35
* @E-mail: justbefree@126.com
*/

/* harmony default export */ var src_amap = (amap);
...
var src_install = function install(Vue) {
  ...
  Vue.component(src_amap.name, src_amap);
};
...
//# sourceMappingURL=vue-amp2.x.umd.js.map