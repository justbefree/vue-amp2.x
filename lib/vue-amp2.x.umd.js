...
* @Last Modified time: 2020-08-10 18:03:47
...
var load_loadMap = function loadMap() {
  return new Promise(function (resolve, reject) {
    dist_default.a.load({
      key: 'ccd1e3a84dd69c646c53abd884db7141',
      version: '2.0',
      plugins: [],
...
// CONCATENATED MODULE: ./src/amap/component/vueAmap.js
/*
* @Author: Just be free
* @Date:   2020-08-07 11:26:09
* @Last Modified by:   Just be free
* @Last Modified time: 2020-09-04 13:55:26
* @E-mail: justbefree@126.com
*/

/* harmony default export */ var vueAmap = ({
  name: 'VueAmap2x',
  props: {
    width: String,
    height: String,
  ...
  methods: {
    ...
    load: function load() {
      ...
      load_loadMap().then(function (AMap) {
        var center = _this.center;
        var map = new AMap.Map('vue-amp2-container', {
          zoom: 13,
          zooms: [10, 19],
          center: center,
          touchZoomCenter: 1
        ...
        map.on("zoomstart", function (e) {
          _this.mapZoomStart(e, map);
        });
        map.on("zoomchange", function (e) {
          _this.mapZoom(e, map);
        });
        map.on("zoomend", function (e) {
          _this.mapZoomEnd(e, map);
        });
        map.on("movestart", function (e) {
          _this.mapMoveStart(e, map);
        });
        map.on("mapmove", function (e) {
          _this.mapMove(e, map);
        });
        map.on("moveend", function (e) {
          _this.mapMoveEnd(e, map);
        });
        map.on("dragstart", function (e) {
          _this.mapDragStart(e, map);
        });
        map.on("dragging", function (e) {
          _this.mapDragging(e, map);
        });
        map.on("dragend", function (e) {
          _this.mapDragEnd(e, map);
        });
        map.on("complete", function (e) {
          _this.mapLoaded(e, map);
        });
      }).catch(function (err) {
...
* @Last Modified by:   Just be free
* @Last Modified time: 2020-08-07 11:30:03
* @E-mail: justbefree@126.com
*/

/* harmony default export */ var amap = (vueAmap);
// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (amap);
